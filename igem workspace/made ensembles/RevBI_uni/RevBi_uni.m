%Main script.
% solves our system using reversible michealis followed by Bi_uni
...
yZero = [0.00001,0.00001,83.3333,83.3333,16.6666,0.00001]; % and an initial condition units ug/ml % the 0.00001's are to stop division by 0
% these correspond to alcohol,AOX,H2O2,HRP,ABTS,ABTS(oxidised)
%the units where in ug/ml, but what matters is the number of particles per volume
% so want e.g. mol/ml. 
% Mr's glucose set  g/mol  
Mr = [180,150000,34,44000,514,514] ; 
