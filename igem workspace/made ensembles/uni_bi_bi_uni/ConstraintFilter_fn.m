...
K(5,:) = randlog_fn(BinNumber,round(FractionSample*Iterations),Kstruct.km2p1);
K(6,:) = randlog_fn(BinNumber,round(FractionSample*Iterations),Kstruct.kcatf2);
K(7,:) = randlog_fn(BinNumber,round(FractionSample*Iterations),Kstruct.km1s2);
K(8,:) = randlog_fn(BinNumber,round(FractionSample*Iterations),Kstruct.km2s2);
K(9,:) = randlog_fn(BinNumber,round(FractionSample*Iterations),Kstruct.keq2);
