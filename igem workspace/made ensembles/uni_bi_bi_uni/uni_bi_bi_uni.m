...
yZero = [0.00001,0.000001,83.333,0.0001,83.33333,16.6666,0.0001]; % and an initial condition
yZero(3) = (yZero(3)/34.0147);
yZero(4) = (yZero(5)/44000);
yZero(5) = (yZero(6)/548.7) ;
store = zeros(length(tRange), 7, Iterations);
for i = 1:Iterations  
